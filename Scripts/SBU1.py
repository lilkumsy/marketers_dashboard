...
cursor.execute("select AccountDesc,BookBal from VwAccMaster  where CreditClassDesc !='performing' AND RelationshipOfficerName in('OKAFOR, ERIC UCHENNA') and PostingDateAdded <='2023-12-31' order by PostingDateAdded asc")
...
sidebar = html.Div(
    [
        html.H6("HEAD OFFICE SBU 1", className="display-6"),
        html.Hr(),
...
if __name__ == "__main__":
    app.run_server(debug='true',host='10.1.0.119', port=9005)
