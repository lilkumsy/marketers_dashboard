...
cursor.execute("select a.AccountDesc as accountName,a.AmountGranted  as amountgranted from VwCreditMaster a,VwAccMaster b  where a.AccountNo=b.AccountNo and a.CreditTypeDesc='Mortgage Loan' and a.PostingDateAdded between '2023-01-01' and '2023-12-01' and RelationshipOfficerName in('Okpe, Friday  ','dalon, gloria Mbibie')")
bar_data = cursor.fetchall()

# Execute the query to fetch data for the pie chart-pbt
query ="select sum(a.AmountGranted)   from VwCreditMaster a,VwAccMaster b where a.AccountNo=b.AccountNo and a.CreditTypeDesc='Mortgage Loan' and a.PostingDateAdded between '2023-01-01' and '2023-12-31' and RelationshipOfficerName in('Okpe, Friday  ','dalon, gloria Mbibie')"
cursor = cnxn.cursor()
...
query2 ="select sum(a.BalAcctCurr) from VwTransHist a,VwAccMaster b where a.AccountNo=b.AccountNo and TransCode in('103','1031') and a.PostingDateAdded between '2023-01-01' and '2023-12-31' and  RelationshipOfficerName in('Okpe, Friday  ','dalon, gloria Mbibie')"
cursor2 = cnxn.cursor()
...
cursor.execute("select AccountDesc,BookBal from VwAccMaster  where CreditClassDesc !='performing' AND RelationshipOfficerName in('Okpe, Friday  ','dalon, gloria Mbibie') and PostingDateAdded <='2023-12-31' order by PostingDateAdded asc")
...
sidebar = html.Div(
    [
        html.H6("SUNCITY BRANCH", className="display-6"),
        html.Hr(),
...
if __name__ == "__main__":
     app.run_server(debug='true',host='10.1.0.119', port=9007)
