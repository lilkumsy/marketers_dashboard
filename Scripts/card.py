...
pbt_data = [('SET TARGET',    231511667), ('ACHIEVED TARGET', progress)]
...
progress = cursor.fetchone()[0]
# update the `pie_data` list with the retrieved progress   
soh_data = [('SET TARGET',    57091667), ('ACHIEVED TARGET', progress)]
# Specify colors for pie chart slices
colors = ['#00203FFF','#ADEFD1FF']  # green for SET TARGET, red for ACHIEVED TARGET
...
progress = cursor.fetchone()[0]
# update the `pie_data` list with the retrieved progress   
pie_data = [('SET TARGET',   2040000000), ('ACHIEVED TARGET', progress)]
# Specify colors for pie chart slices
colors = ['#00203FFF','#ADEFD1FF']  # green for SET TARGET, red for ACHIEVED TARGET
...
# update the `pie_data` list with the retrieved progress   
pie_data2 = [('SET TARGET',  2117323082), ('ACHIEVED TARGET', progress2)]
# Specify colors for pie chart slices
colors = ['#00203FFF','#ADEFD1FF']  # green for SET TARGET, red for ACHIEVED TARGET
...
if __name__ == "__main__":
    app.run_server(debug='true',host='10.2.2.50', port=9000)
